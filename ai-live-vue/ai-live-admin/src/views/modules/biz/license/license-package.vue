  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('biz:licensepackage:save')" type="primary" @click="addOrUpdateHandle()">新增</el-button>
        <el-button v-if="isAuth('biz:licensepackage:delete')" :disabled="dataListSelections.length <= 0" type="danger" @click="deleteHandle()">批量删除</el-button>
      </el-form-item>
    </el-form>
    <el-table
      ...
      <el-table-column align="center" header-align="center" label="有效期(天)" prop="duration"></el-table-column>
...
<script>
import AddOrUpdate from './license-package-add-or-update'
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      this.$http({
        url: this.$http.adornUrl('/biz/license-package/list'),
        method: 'get',
    ...
    deleteHandle(id) {
      ...
      this.$confirm(`确定对[${ids.join(',')}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
        ...
        this.$http({
          url: this.$http.adornUrl('/biz/license-package/delete'),
          method: 'post',
