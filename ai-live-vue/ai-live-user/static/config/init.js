...
;(function() {
  var resList = {
    ...
    js: [
      // 插件, 放置业务之前加载, 以免业务需求依赖插件时, 还未加载出错bmap.min.js
      // 插件 - echarts
      window.SITE_CONFIG.cdnUrl + '/static/plugins/echarts-5.4.3/echarts.min.js',
      window.SITE_CONFIG.cdnUrl + '/static/plugins/echarts-5.4.3/bmap.min.js',
      // 业务
