      ...
      <div class="site-content">
        ...
        <div class="login-main">
          ...
          <el-form :model="dataForm" :rules="dataRule" ref="dataForm" status-icon>
            ...
            <el-form-item>
              <el-button class="login-btn-submit" type="primary" :loading="registerLoading" @click="dataFormSubmit()">重置密码</el-button>
      ...
      dataFormSubmit () {
        ...
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            ...
            this.$http({
              url: this.$http.adornUrl('/apps/merchant/resetPassword'),
              method: 'post',
      ...
      sendCode() {
        ...
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            ...
            this.$http({
              url: this.$http.adornUrl('/apps/emailaccount/resetCode'),
              method: 'post',
              data: this.$http.adornData({
