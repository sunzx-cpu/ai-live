                ...
                <view class="popup-bg">
                    <view class="popup-content" :class="{'popup-content-show' : popup_show}">
                        <view class="update-wrap">
                            ...
                            <view class="content">
                                <text class="title">New App Version V{{update_info.version}}</text>
                                <!-- 升级描述 -->
                                <view class="title-sub" v-html="update_info.note"></view>
                                <!-- 升级按钮 -->
                                <button class="btn" v-if="downstatus < 1" @click="onUpdate()">Update Now</button>
                                <!-- 下载进度 -->
                                <view class="sche-wrap" v-else>
                                    ...
                                    <text class="down-text">Download:{{(downSize/1024/1024 ).toFixed(2)}}M/{{(fileSize/1024/1024).toFixed(2)}}M</text>
                                </view>
                            </view>
                        </view>
                        <image src="../components/yzhua006-update/images/close.png" class="close-ioc" @click="closeUpdate()" v-if="downstatus < 1 && update_info.force == 0"></image>
                    </view>
                </view>
            </view>
        </view>
...
<script>
    export default {
        ...
        methods: {
            ...
            // 下载升级资源包
            download_wgt() {
                plus.nativeUI.showWaiting("Downloading..."); //下载更新文件...
                let options = {
                    method: "get"
                };
            ...
            // 安装文件
            installWgt(path) {
                plus.nativeUI.showWaiting("Install..."); //安装更新文件...
